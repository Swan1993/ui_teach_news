                                    ...
                                    Navigator.push(
                                      ...
                                      MaterialPageRoute(
                                        builder: (context) => ViewPost(
                                          index: index,
                                          image: snapshot.data!
                                              .image!, // Replace 'date.image!' with the actual image URL
            ...
            Expanded(
              child: FutureBuilder(
                ...
                builder: (BuildContext context,
                    AsyncSnapshot<PosterModel> snapshot) {
                  if (snapshot.hasData) {
                    return SizedBox(
                      width: size.width,
                      height: size.height,
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                image: DecorationImage(
                                  fit: BoxFit.cover,
                                  image:
                                      Image.network(snapshot.data!.image).image,
                                ),
                              ),
                            ),
                            const SizedBox(height: medium),
                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return InkWell(
                                ...
                                // Rest of your widget code for displaying the item
                              );
                            },
                          ),
                        );
